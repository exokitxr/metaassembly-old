  ...
  'targets': [
    {
      ...
      'sources': [
        ...
        'src/thirdparty/sjpeg/headers.cc',
        'src/thirdparty/sjpeg/enc.cc',
        'src/thirdparty/sjpeg/bit_writer.cc',
        'src/thirdparty/sjpeg/colors_rgb.cc',
        'src/thirdparty/sjpeg/dichotomy.cc',
        'src/thirdparty/sjpeg/fdct.cc',
        'src/thirdparty/sjpeg/yuv_convert.cc',
        'src/thirdparty/sjpeg/jpeg_tools.cc',
        'src/thirdparty/sjpeg/score_7.cc',
      ],
      'include_dirs': [
